-- ============================================================================
-- COMPLETE DUMMY DATA INSERT - Full ERP System (FIXED)
...
DECLARE
    ...
    -- Product Variations (parent)
    v_pvar_1 INTEGER; v_pvar_2 INTEGER; v_pvar_3 INTEGER;
    v_pvar_4 INTEGER; v_pvar_5 INTEGER; v_pvar_6 INTEGER;
    
    -- Variation IDs (child)
    v_var_1 INTEGER; v_var_2 INTEGER; v_var_3 INTEGER;
    v_var_4 INTEGER; v_var_5 INTEGER; v_var_6 INTEGER;
...
BEGIN
    ...
    -- ========================================================================
    -- 1. CATEGORIES & UNITS (One by one to avoid "more than one row" error)
    -- ========================================================================
    
    INSERT INTO categories (business_id, name, short_code, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Electronics', 'ELEC', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_cat_electronics;
    
    INSERT INTO categories (business_id, name, short_code, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Clothing', 'CLOTH', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_cat_clothing;
    
    INSERT INTO categories (business_id, name, short_code, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Grocery', 'GROC', v_owner_id, NOW(), NOW())
    ...
    VALUES (v_business_id, 'Piece', 'Pc', FALSE, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_unit_piece;
    
    INSERT INTO units (business_id, actual_name, short_name, allow_decimal, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Kilogram', 'Kg', TRUE, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_unit_kg;
    
    INSERT INTO units (business_id, actual_name, short_name, allow_decimal, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Box', 'Box', FALSE, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_unit_box;
    
    RAISE NOTICE '  ✅ Categories (3) & Units (3)';
    
    -- ========================================================================
    -- 2. CONTACTS (Customers & Suppliers) - One by one
    -- ========================================================================
    ...
    INSERT INTO contacts (business_id, type, name, mobile, email, city, created_by, created_at, updated_at)
    VALUES (v_business_id, 'customer', 'Walk-in Customer', NULL, NULL, NULL, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_cust_5;
    
    INSERT INTO contacts (business_id, type, name, mobile, email, city, created_by, created_at, updated_at)
    VALUES (v_business_id, 'supplier', 'Tech Suppliers Ltd', '+92-51-1234567', 'tech@suppliers.com', 'Islamabad', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_supp_1;
    
    INSERT INTO contacts (business_id, type, name, mobile, email, city, created_by, created_at, updated_at)
    VALUES (v_business_id, 'supplier', 'Wholesale Traders', '+92-51-2345678', 'wholesale@traders.com', 'Rawalpindi', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_supp_2;
    
    INSERT INTO contacts (business_id, type, name, mobile, email, city, created_by, created_at, updated_at)
    VALUES (v_business_id, 'supplier', 'Import House Pvt Ltd', '+92-51-3456789', 'import@house.com', 'Islamabad', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_supp_3;
    
    RAISE NOTICE '  ✅ Contacts: 5 Customers + 3 Suppliers';
    
    -- ========================================================================
    -- 3. PRODUCTS (6 products) - One by one
    -- ========================================================================
    
    INSERT INTO products (name, business_id, type, unit_id, sku, category_id, alert_quantity, created_by, created_at, updated_at)
    VALUES ('Laptop HP ProBook 450', v_business_id, 'single', v_unit_piece, 'LAP-HP-450', v_cat_electronics, 5, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_prod_1;
    
    INSERT INTO products (name, business_id, type, unit_id, sku, category_id, alert_quantity, created_by, created_at, updated_at)
    VALUES ('Samsung Galaxy A54', v_business_id, 'single', v_unit_piece, 'MOB-SAM-A54', v_cat_electronics, 10, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_prod_2;
    
    INSERT INTO products (name, business_id, type, unit_id, sku, category_id, alert_quantity, created_by, created_at, updated_at)
    VALUES ('T-Shirt Cotton Premium', v_business_id, 'single', v_unit_piece, 'TSH-COT-001', v_cat_clothing, 20, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_prod_3;
    
    INSERT INTO products (name, business_id, type, unit_id, sku, category_id, alert_quantity, created_by, created_at, updated_at)
    VALUES ('Jeans Denim Blue', v_business_id, 'single', v_unit_piece, 'JNS-DEN-BLU', v_cat_clothing, 15, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_prod_4;
    
    INSERT INTO products (name, business_id, type, unit_id, sku, category_id, alert_quantity, created_by, created_at, updated_at)
    VALUES ('Basmati Rice Super', v_business_id, 'single', v_unit_kg, 'RICE-BAS-5KG', v_cat_grocery, 50, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_prod_5;
    
    INSERT INTO products (name, business_id, type, unit_id, sku, category_id, alert_quantity, created_by, created_at, updated_at)
    VALUES ('Cooking Oil 5L', v_business_id, 'single', v_unit_piece, 'OIL-COK-5L', v_cat_grocery, 30, v_owner_id, NOW(), NOW())
    RETURNING id INTO v_prod_6;
    
    RAISE NOTICE '  ✅ Products: 6 created';
    
    -- ========================================================================
    -- 4. PRODUCT VARIATIONS (Required for inventory) - One by one
    -- ========================================================================
    ...
    VALUES (v_prod_1, 'DUMMY', TRUE, NOW(), NOW())
    RETURNING id INTO v_pvar_1;
    
    INSERT INTO product_variations (product_id, name, is_dummy, created_at, updated_at)
    VALUES (v_prod_2, 'DUMMY', TRUE, NOW(), NOW())
    RETURNING id INTO v_pvar_2;
    
    INSERT INTO product_variations (product_id, name, is_dummy, created_at, updated_at)
    VALUES (v_prod_3, 'DUMMY', TRUE, NOW(), NOW())
    RETURNING id INTO v_pvar_3;
    
    INSERT INTO product_variations (product_id, name, is_dummy, created_at, updated_at)
    VALUES (v_prod_4, 'DUMMY', TRUE, NOW(), NOW())
    RETURNING id INTO v_pvar_4;
    
    INSERT INTO product_variations (product_id, name, is_dummy, created_at, updated_at)
    VALUES (v_prod_5, 'DUMMY', TRUE, NOW(), NOW())
    RETURNING id INTO v_pvar_5;
    
    INSERT INTO product_variations (product_id, name, is_dummy, created_at, updated_at)
    VALUES (v_prod_6, 'DUMMY', TRUE, NOW(), NOW())
    RETURNING id INTO v_pvar_6;
    ...
    ) VALUES ('DUMMY', v_prod_1, v_pvar_1, 'LAP-HP-450', 85000, 95000, 85000, 11.76, 95000, 92000, NOW(), NOW())
    ...
    INSERT INTO variations (
        ...
        dpp_inc_tax, profit_percent, retail_price, wholesale_price,
        created_at, updated_at
    ) VALUES ('DUMMY', v_prod_2, v_pvar_2, 'MOB-SAM-A54', 55000, 62000, 55000, 12.73, 62000, 60000, NOW(), NOW())
    ...
    INSERT INTO variations (
        ...
        dpp_inc_tax, profit_percent, retail_price, wholesale_price,
        created_at, updated_at
    ) VALUES ('DUMMY', v_prod_3, v_pvar_3, 'TSH-COT-001', 800, 1200, 800, 50.00, 1200, 1100, NOW(), NOW())
    ...
    INSERT INTO variations (
        ...
        dpp_inc_tax, profit_percent, retail_price, wholesale_price,
        created_at, updated_at
    ) VALUES ('DUMMY', v_prod_4, v_pvar_4, 'JNS-DEN-BLU', 2000, 2800, 2000, 40.00, 2800, 2600, NOW(), NOW())
    ...
    INSERT INTO variations (
        ...
        dpp_inc_tax, profit_percent, retail_price, wholesale_price,
        created_at, updated_at
    ) VALUES ('DUMMY', v_prod_5, v_pvar_5, 'RICE-BAS-5KG', 450, 550, 450, 22.22, 550, 520, NOW(), NOW())
    ...
    INSERT INTO variations (
        ...
        dpp_inc_tax, profit_percent, retail_price, wholesale_price,
        created_at, updated_at
    ) VALUES ('DUMMY', v_prod_6, v_pvar_6, 'OIL-COK-5L', 950, 1150, 950, 21.05, 1150, 1100, NOW(), NOW())
    RETURNING id INTO v_var_6;
    ...
    INSERT INTO variation_location_details (
        ...
        (v_prod_1, v_pvar_1, v_var_1, v_branch_main, 8.00, NOW(), NOW()),
        (v_prod_2, v_pvar_2, v_var_2, v_branch_main, 15.00, NOW(), NOW()),
        (v_prod_3, v_pvar_3, v_var_3, v_branch_main, 45.00, NOW(), NOW()),
        (v_prod_4, v_pvar_4, v_var_4, v_branch_main, 30.00, NOW(), NOW()),
        (v_prod_5, v_pvar_5, v_var_5, v_branch_main, 120.00, NOW(), NOW()),
        (v_prod_6, v_pvar_6, v_var_6, v_branch_main, 50.00, NOW(), NOW());
    ...
    INSERT INTO variation_location_details (
        ...
        (v_prod_1, v_pvar_1, v_var_1, v_branch_city, 5.00, NOW(), NOW()),
        (v_prod_2, v_pvar_2, v_var_2, v_branch_city, 25.00, NOW(), NOW()),
        (v_prod_3, v_pvar_3, v_var_3, v_branch_city, 60.00, NOW(), NOW()),
        (v_prod_4, v_pvar_4, v_var_4, v_branch_city, 20.00, NOW(), NOW()),
        (v_prod_5, v_pvar_5, v_var_5, v_branch_city, 80.00, NOW(), NOW()),
        (v_prod_6, v_pvar_6, v_var_6, v_branch_city, 40.00, NOW(), NOW());
    ...
    INSERT INTO variation_location_details (
        ...
        (v_prod_1, v_pvar_1, v_var_1, v_branch_warehouse, 20.00, NOW(), NOW()),
        (v_prod_2, v_pvar_2, v_var_2, v_branch_warehouse, 50.00, NOW(), NOW()),
        (v_prod_3, v_pvar_3, v_var_3, v_branch_warehouse, 200.00, NOW(), NOW()),
        (v_prod_4, v_pvar_4, v_var_4, v_branch_warehouse, 100.00, NOW(), NOW()),
        (v_prod_5, v_pvar_5, v_var_5, v_branch_warehouse, 500.00, NOW(), NOW()),
        (v_prod_6, v_pvar_6, v_var_6, v_branch_warehouse, 300.00, NOW(), NOW());
    ...
    INSERT INTO financial_accounts (
        business_id, name, account_number, type, 
        created_by, created_at, updated_at
    ) VALUES 
        (v_business_id, 'Cash in Hand', 'CASH-001', 'cash', v_owner_id, NOW(), NOW()),
        (v_business_id, 'Bank Account - HBL', 'BANK-HBL-001', 'bank', v_owner_id, NOW(), NOW()),
        (v_business_id, 'Mobile Wallet - JazzCash', 'WALLET-001', 'wallet', v_owner_id, NOW(), NOW()),
        (v_business_id, 'Credit Card - Meezan', 'CC-001', 'credit_card', v_owner_id, NOW(), NOW());
    ...
    VALUES (v_business_id, 'Rent', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_exp_cat_rent;
    
    INSERT INTO expense_categories (business_id, name, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Utilities', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_exp_cat_utility;
    
    INSERT INTO expense_categories (business_id, name, created_by, created_at, updated_at)
    VALUES (v_business_id, 'Salaries', v_owner_id, NOW(), NOW())
    RETURNING id INTO v_exp_cat_salary;
