...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        try { Schema::table('variations', function (Blueprint $table) {
            $table->index('variation_value_id');
        }); } catch (\Exception $e) { /* Column or index may not exist */ }

        try { Schema::table('cash_register_transactions', function (Blueprint $table) {
            $table->index('transaction_id');
        }); } catch (\Exception $e) { /* Column or index may not exist */ }
        ...
        try { Schema::table('units', function (Blueprint $table) {
            $table->index('base_unit_id');
        }); } catch (\Exception $e) { /* Column or index may not exist */ }

        try { Schema::table('discounts', function (Blueprint $table) {
