...
<!-- Hidden container for form errors -->
<div id="form-error-container" style="display:none; margin-top: 20px; padding: 15px; background-color: #f8d7da; border: 1px solid #f5c6cb; border-radius: 4px; color: #721c24;">
    <strong>Please correct the following errors:</strong>
    <ul id="form-error-list" style="margin-top: 10px; margin-bottom: 0;"></ul>
</div>
