...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="610C System">
    <link rel="apple-touch-icon" href="/610c/public/images/icons/icon-192x192.png">
    <link rel="manifest" href="/610c/public/manifest.json">
...
<body
    ...
    <div class="tw-flex thetop">
        ...
        {{-- PWA Registration --}}
        <script src="/610c/public/js/pwa-register.js"></script>
